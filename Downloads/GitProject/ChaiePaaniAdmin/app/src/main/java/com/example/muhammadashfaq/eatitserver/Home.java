...
import com.example.muhammadashfaq.eatitserver.Service.ListenResturant;
...
//        startService(serviceResturant);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if(id==R.id.nav_order){
            ...
            startActivity(intent);
        }else if(id==R.id.nav_request_res){
            Intent intent=new Intent(Home.this,AddRestrurantStatus.class);
            startActivity(intent);
        }
